...
# Train the model
start = time()
clf1.fit(X_train[:50000], y_train[:50000])
values.append(time() - start)
# print(time()-start)

# Compute the accuracy score towards train data
start = time()
train_acc.append(clf1.score(X_train[:50000], y_train[:50000]))
...
start = time()
test_acc.append(clf1.score(X_test[:10000], y_test[:10000]))
...
svm_predictions = clf1.predict(X_test[:10000])
...
# Compute the accuracy score towards train data
start = time()
train_acc.append(clf.score(X_train[:50000], y_train[:50000]))
# print(clf.score(X_train[:5000], y_train[:5000]))
...
# Compute the accuracy score towards test data
start = time()
test_acc.append(clf.score(X_test[:10000], y_test[:10000]))
# print(clf.score(X_test[:1000], y_test[:1000]))
